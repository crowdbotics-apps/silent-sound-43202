"""
Django settings for silent_sound_43202 project.
...
ROOT_URLCONF = 'silent_sound_43202.urls'
...
WSGI_APPLICATION = 'silent_sound_43202.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_sound_43202 API",
    "DESCRIPTION": "API documentation for silent_sound_43202 App",
    "VERSION": "v1",
}
